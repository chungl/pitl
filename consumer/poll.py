...
if __name__ == '__main__':
    stores = [
        SQLiteStore('/Users/casey/data/cats/', 'weights.db', 'measurements', 'http://cats.local:8000'),
        SQLiteStore('/Users/casey/data/cats/', 'weights2.db', 'measurements', 'http://cam.local:8000')
    ]
    period_s = 15
    def sync(store_index, scheduler):
        # schedule next
        scheduler.enter(period_s, 1, sync, (store_index, scheduler,))
        # execute
    ...
    def sync_clips(store_index, path, fps, scheduler):
        ...
        scheduler.enter(period_s, 1, sync_clips, (store_index, path, fps, scheduler,))
